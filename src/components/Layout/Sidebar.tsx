...
const menuItems = [
  ...
  { id: 'activities', path: '/activities', icon: Activity, roles: ['admin', 'editor'] },
  { id: 'events', path: '/events', icon: Calendar, roles: ['admin', 'editor'] },
  { id: 'notices', path: '/notices', icon: Megaphone, roles: ['admin', 'editor'] },
  { id: 'users', path: '/users', icon: Users, roles: ['admin'] },
  { id: 'analytics', path: '/analytics', icon: BarChart3, roles: [] },
  { id: 'notifications', path: '/notifications', icon: Bell, roles: ['admin', 'editor'] },
        ...
        {!sidebarCollapsed && (
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
              <span className="text-white text-sm font-bold">J2L</span>
            </div>
            <div>
              <h1 className="text-sm font-semibold text-text-title-strong">Javea2Live</h1>
              <p className="text-xs text-text-body">Ayuntamiento</p>
            </div>
          </div>
        )}
        <button
