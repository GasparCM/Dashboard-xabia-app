...
import { Download, Calendar, Filter, TrendingUp, TrendingDown, Users, Activity, Eye, Clock } from 'lucide-react';
...
export const Analytics: React.FC = () => {
  ...
  useEffect(() => {
    const loadAnalytics = async () => {
      try {
        const [kpisData, sessionsData, categoriesData, languagesData] = await Promise.all([
          mockAPI.getKPIs(),
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-text-title-strong text-lg font-medium">Estadísticas y Analíticas</h2>
          <p className="text-text-body mt-1">Análisis detallado del uso de Javea2Live</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-text-title-strong font-medium">Sesiones Diarias</h3>
        ...
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-text-title-strong font-medium">Categorías Más Visitadas</h3>
            <Button variant="outline" size="sm">Ver detalles</Button>
          </div>
        ...
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-text-title-strong font-medium">Distribución por Idioma</h3>
            <Button variant="outline" size="sm">Ver detalles</Button>
          </div>
        ...
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-text-title-strong font-medium">Retención de Usuarios</h3>
            <Button variant="outline" size="sm">Ver detalles</Button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Top Content */}
        <Card>
          <h3 className="text-text-title-strong font-medium mb-4">Contenido Más Popular</h3>
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50">
                <div>
                  ...
                  <p className="text-sm text-text-body">{item.views} visualizaciones</p>
                </div>
                <div className={`text-sm ${item.change > 0 ? 'text-success' : 'text-error'}`}>
        ...
        {/* User Behavior */}
        <Card>
          <h3 className="text-text-title-strong font-medium mb-4">Comportamiento de Usuario</h3>
        ...
        {/* Device Stats */}
        <Card>
          <h3 className="text-text-title-strong font-medium mb-4">Dispositivos y Plataformas</h3>
          <div className="space-y-4">
            <div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-success h-2 rounded-full" style={{ width: '7%' }}></div>
              </div>
            </div>
          </div>
        </Card>
